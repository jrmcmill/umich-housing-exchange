export const listings = [
  {
    id: 'north-campus-summer-studio',
    title: 'Studio near North Campus - Summer',
    price: 860,
    bedrooms: 0,
    bathrooms: 1,
    ...
    description:
      'Quiet studio with in-unit laundry, bike storage, and a short walk to bus routes. Flexible dates for interns.',
    images: [
  ...
  },
  {
    ...
    title: '2BR in Kerrytown - Summer Sublease',
    price: 1180,
    bedrooms: 2,
    bathrooms: 1,
    ...
    description:
      'Bright two-bedroom with spacious common area, furnished bedrooms, and easy access to downtown and Central Campus.',
    images: [
  ...
  },
  {
    ...
    title: '1BR near Central Campus - Fall',
    price: 1025,
    bedrooms: 1,
    bathrooms: 1,
    ...
    description:
      'Private one-bedroom with balcony, strong natural light, and quick walk to campus libraries. Ideal for fall term.',
    images: [
  ...
  },
  {
    ...
    title: '4BR house on the West Side',
    price: 720,
    bedrooms: 4,
    bathrooms: 2,
    available_from: '2026-05-15',
    available_to: '2026-08-10',
    location: 'West Side',
    neighborhood: 'Old West Side',
    description:
      'Shared house with large yard, basement storage, and parking. Best for a group looking for a full summer takeover.',
    images: [
  ...
  },
  {
    ...
    title: 'Short-term 1BR by Kerrytown Market',
    price: 940,
    bedrooms: 1,
    bathrooms: 1,
    ...
    location: 'Kerrytown',
    neighborhood: 'Kingsley',
    description:
      'Minimal, furnished short-term option with Wi-Fi included and a flexible move-in window for interns or summer research.',
    images: [
  ...
  },
  {
    ...
    title: 'Studio near Medical Campus',
    price: 790,
    bedrooms: 0,
    bathrooms: 1,
    ...
    description:
      'Efficient studio near the hospital and bus lines, perfect for rotation students or summer interns.',
    images: [
